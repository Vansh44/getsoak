...
│   │                          # idempotent checkpoints/events and three read-only templates;
│   │                          # workflow-template-data.ts owns bounded weekly/revenue/product-launch
│   │                          # snapshots, exact-SKU resolution and parallel evidence reads;
...
the trusted `store_id`, and direct customer PII is minimized/masked.
     ...
     55-case live tool-choice/security/latency gate. The complementary
     ...
     publishes the guide; migrations 0036–0058 and 0072 keep
