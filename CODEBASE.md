...
│   │                          # Transfer, cancellation, refund and shipment authority remain unavailable.
...
20a. **Mink AI dashboard agent — invited read, private drafting and guarded Phase 4/5C action beta.** This is separate
...
the trusted `store_id`, and direct customer PII is minimized/masked.
     ...
     publishes the guide; migrations 0036–0051 keep
