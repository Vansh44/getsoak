...
│   │                          # 72-case live tool/safety/latency gate.
...
the trusted `store_id`, and direct customer PII is minimized/masked.
     ...
     72-case live tool-choice/security/latency gate. The complementary
