...
│   │                          # idempotent checkpoints/events and four durable templates;
│   │                          # workflow-template-data.ts owns bounded weekly/revenue/product-launch/
│   │                          # slow-inventory snapshots, exact-SKU resolution and evidence reads;
...
│   │                          # 59-case live tool/safety/latency gate.
...
the trusted `store_id`, and direct customer PII is minimized/masked.
     ...
     59-case live tool-choice/security/latency gate. The complementary
     ...
     publishes the guide; migrations 0036–0058, 0072 and 0073 keep
