...
| Studio | Passes the automated package gate as hidden preset `studio@0.1.0` on `storefront-editorial@1`; asset provenance is recorded | Local homepage/shop/PDP/cart/content/404 smoke passed; public demo is not provisioned, manifest is `provisioning`, and no catalog/signup exposure exists                      | Not recorded                   | Not reviewed; authoring review does not count toward the two-reviewer gate | Draft         |
| Ritual | Passes the automated package gate as hidden preset `ritual@0.1.0` on `storefront-editorial@1`; asset provenance is recorded | Local route smoke plus variant add-to-cart and totals passed; public demo is not provisioned, manifest is `provisioning`, and no catalog/signup exposure exists               | Not recorded                   | Not reviewed; authoring review does not count toward the two-reviewer gate | Draft         |
