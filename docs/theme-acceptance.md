...
| Studio | Passes the automated package gate as hidden preset `studio@0.1.0` on `storefront-editorial@1`; asset provenance is recorded | Production desktop/tablet/mobile route and commerce sweep passed on 2026-08-11. The `f1` manifest records the demo healthy; exposure remains hidden. | **Failed baseline:** Accessibility 94, Performance 43, LCP 5.82 s. Candidate contrast, semantics, and LCP-priority fixes await deployment/reseed and retest. | Not reviewed; authoring review does not count toward the two-reviewer gate | Blocked       |
| Ritual | Passes the automated package gate as hidden preset `ritual@0.1.0` on `storefront-editorial@1`; asset provenance is recorded | Production desktop/tablet/mobile route and commerce sweep passed on 2026-08-11. The `f1` manifest records the demo healthy; exposure remains hidden. | **Failed baseline:** Accessibility 94, Performance 59, LCP 4.72 s. Candidate contrast, semantics, and LCP-priority fixes await deployment/reseed and retest. | Not reviewed; authoring review does not count toward the two-reviewer gate | Blocked       |
...
any theme as an approved catalog release. Studio and Ritual's detailed
production record is `docs/theme-release-audit-2026-08-11.md`.
