...
| ------ | --------------------------------------------------------------------------------------------------------------------------- | ---------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- | ------------------------------ | -------------------------------------------------------------------------- | ------------- |
| Basket | Passes the package gate; registered as preset `basket@1.0.0` on engine `storefront-grocery@1`                               | **Production blocked:** public demo is still the StoreMink 404 and manifest preview is disabled. Local demo route/PDP/cart smoke passed after the `locations_10` stock repair                                                                                                                                                                                                                                                                                                | Not recorded against this gate | Prior visual review is historical and does not satisfy this release gate   | Blocked       |
| Studio | Passes the automated package gate as hidden preset `studio@0.1.0` on `storefront-editorial@1`; asset provenance is recorded | Production demo is provisioned. Its first visual review found linked CTA contrast, oversized PDP actions and homepage gallery imagery, cart alignment, and an overly black-heavy composition; the local candidate now uses framed light product cards, a pale-cobalt editorial field, a light newsletter and footer, and a bounded landscape lookbook, but awaits deployment. Manifest remains `provisioning`, with no catalog/signup exposure                               | Not recorded                   | Not reviewed; authoring review does not count toward the two-reviewer gate | Draft         |
| Ritual | Passes the automated package gate as hidden preset `ritual@0.1.0` on `storefront-editorial@1`; asset provenance is recorded | Production demo is provisioned. Its first visual review found linked CTA contrast, oversized PDP actions and homepage gallery imagery, excess PDP media whitespace, cart alignment, and pill-shaped summary, account-menu, and review-panel defects; the local candidate has readable CTA text, 55px PDP actions, 4:3 PDP media, 22px card corners, and a bounded landscape gallery, but awaits deployment. Manifest remains `provisioning`, with no catalog/signup exposure | Not recorded                   | Not reviewed; authoring review does not count toward the two-reviewer gate | Draft         |
