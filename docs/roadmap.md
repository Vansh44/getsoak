...
| Analytics **phases 2–4**        | Phase 1 shipped 2026-08-18: IANA-zone URL ranges/comparisons, recognized Total sales less completed refunds, raw-rupee charting, staff location scope, hidden store-wide customer snapshot, and per-widget streaming. Next: persistent editor → commerce widgets/location selector → Search Console. Spec: `docs/analytics-and-search-console-plan.md` |
