...
| Analytics **remaining phases** | Phase 1, Phase 2a–2d, Search Console Phase 3a–3d, the first report/CSV release, platform feature controls, and a complete Analytics Help Centre guide set shipped through 2026-08-20. The operator console can disable core Analytics, customization, drill-down/CSV, and Google Search independently; GA4, Meta Pixel, storefront conversion, and margin are registered as planned, default-off Pro modules. Plan pages advertise Advanced analytics on Pro only. Eight guides document every shipped dashboard entity, source, report, export, customization workflow, and troubleshooting path; detailed GA4 and Meta setup documents remain drafts until those integrations ship. Migrations `20260820_0007_platform_analytics_controls` and `20260820_0008_analytics_help_documents` must be applied; Cloud Scheduler still needs deployment-time creation/verification. Next product build: consent policy plus Pro-only merchant pixels. Spec: `docs/analytics-and-search-console-plan.md` |
