...
// The FULL notification matrix — every notification, every filter. Reached from
// "All notifications" on the landing page, which leads instead with the two
// things most stores actually want to set up (customer emails, team alerts).
// Keeping the complete list one click away means power is available without
// being the first thing a merchant meets.
//
// Gated on the `notifications` permission section —
